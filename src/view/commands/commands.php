            ...
            <table>
                <tr valign="top">
                    ...
                    <form action="commands.php" onsubmit="return false">
                        ...
                        <div class="line">
                            <label for="request_command" class="left">Command</label>
                            <span class="right">
                                <select id="request_command" onchange="changeCommand(this);">
                        ...
                        <div class="line">
                            ...
                            <span class="right">
                                <?php echo Components::serverSelect('request_server'); ?>
                            </span>
                        </div>
                        <div class="line">
                            <span class="left">API</span>
                            <span class="right">
                                <?php echo Components::apiList($_ini->get('get_api'), 'request_api'); ?>
                            </span>
                        </div>
                        <div class="line" style="text-align:center;">
                            <hr/>
                            <input class="header" type="submit"
                                onclick="executeCommand('container'); this.blur();" value="Execute Command"/>
                        </div>
                    </form>
                    </td>
					...
					Available commands :
					<ul>
						<li>get : retrieve a key value</li>
            ...
            <table>
                <tr valign="top">
                    ...
                    <div class="line">
                        <span class="left">Server</span>
                        <span class="right">
                            <?php echo Components::serverSelect('request_telnet_server'); ?>
                        </span>
                    </div>
                    <div class="line" style="text-align:center;">
                        <hr/>
                        <input class="header" type="submit"
                            onclick="executeTelnet('container'); this.blur();" value="Execute Telnet Command"/>
                    </div>
                    </td>
                    <td class="padding" style="border-left:1px solid #ffffff;padding-left:14px;">
                        ...
                        <br/>
                        <br/>
                        For more information about memcached commands, see memcached protocol
                        <a href="https://github.com/memcached/memcached/blob/master/doc/protocol.txt" target="_blank"><span class="green">here</span></a>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table>
                <tr valign="top">
                    ...
                    <div class="line">
                        <span class="left">Server</span>
                        <span class="right">
                            <?php echo Components::serverSelect('search_server'); ?>
                        </span>
                    </div>
                    <div class="line">
                        <label for="search_level" class="left">Detail Level</label>
                        <span class="right">
                    ...
                    <div class="line">
                        <label for="search_more" class="left">Action</label>
                        <span class="right">
                    ...
                    <div class="line" style="text-align:center;">
                        <hr/>
                        <input class="header" type="submit" onclick="searchKey('container'); this.blur();" value="Search Key"/>
                    </div>
                    </td>
                    <td class="padding" style="border-left:1px solid #ffffff;padding-left:14px;">
                        <span class="red">Warning !</span><br/>
                        This thing is only for debugging issue, do not use it in a production environment as it can lock or impact your memcached servers performances.<br/>
                        Also keep in mind that it does not list all keys. It lists keys up to a certain buffer size (1 or 2MB), and it lists key that are expired.<br/><br/>
